(function () {
  ...
  window.ExamGuardApi = {
    ...
    createClass: (name, subject) => request("/api/classes", { method: "POST", body: JSON.stringify({ name, subject }) }),
    ...
    assignExam: (examId, classId) => request("/api/assignments", { method: "POST", body: JSON.stringify({ examId, classId }) }),
    submitExam: (examId, payload) => request(`/api/exams/${examId}/attempts`, { method: "POST", body: JSON.stringify(payload) }),
