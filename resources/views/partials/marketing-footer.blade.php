        ...
        <div class="mb-12 grid gap-8 md:grid-cols-4">
            <div class="space-y-3 md:col-span-1">
                <a href="/" class="flex items-center gap-2.5 text-white"
                   style="font-family:'Space Grotesk',sans-serif; font-size:17px; font-weight:600; letter-spacing:-0.3px;">
                    <img src="/images/logo.png" alt="examguard" class="h-10 w-auto object-contain drop-shadow-[0_0_6px_rgba(59,130,246,0.5)]">
                    examguard.
                </a>
